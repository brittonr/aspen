...
| 3 | `jobs-ci-core` | `aspen-jobs-core`, `aspen-jobs`, `aspen-jobs-protocol`, `aspen-jobs-guest`, `aspen-jobs-worker-*`, `aspen-ci-core`, `aspen-ci`, `aspen-ci-handler`, `aspen-job-handler`, `aspen-ci-executor-*` | Portable payload/wire/keyspace/route/status/handle contracts now live on owning surfaces; active owner/public API review is confirming canonical surfaces, compatibility re-export ownership, runtime-shell exclusions, and fresh evidence before readiness changes. | Refresh manifest/policy/evidence, keep executor/handler negative checks, and rerun CI/jobs compatibility evidence. |
...
| Jobs and CI core | `service library` | `aspen-jobs-core`, `aspen-jobs-protocol`, `aspen-jobs`, `aspen-jobs-guest`, `aspen-jobs-worker-*`, `aspen-ci-core`, `aspen-ci`, `aspen-ci-handler`, `aspen-job-handler`, `aspen-ci-executor-*` | Aspen jobs and CI maintainers | [`crate-extraction/jobs-ci-core.md`](crate-extraction/jobs-ci-core.md) | `workspace-internal` | Post-extraction cleanup moved portable payload/wire/keyspace/route/status/handle contracts to owning surfaces; active owner/public API review must refresh evidence before any readiness raise. |
