...
| Protocol/wire | `protocol/wire` | `aspen-client-api`, `aspen-forge-protocol`, `aspen-jobs-protocol`, `aspen-coordination-protocol` | Aspen protocol maintainers | [`crate-extraction/protocol-wire.md`](crate-extraction/protocol-wire.md) | `workspace-internal` | Verify downstream fixture and compatibility rails before raising readiness. |
...
| Jobs and CI core | `service library` | `aspen-jobs-protocol`, `aspen-jobs`, `aspen-ci-core`, executors | Aspen jobs and CI maintainers | [`crate-extraction/jobs-ci-core.md`](crate-extraction/jobs-ci-core.md) | `workspace-internal` | Inventory, portable fixture, negative runtime boundary checks, and compatibility evidence are present; next action is deciding whether reusable scheduler/run-state helpers should move out of runtime `aspen-jobs`. |
