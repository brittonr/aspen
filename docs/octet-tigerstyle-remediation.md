...
Plan ref: `blake3:92573e77140a3ea65799efbed7d38ddfac39d9a941265b06f4ac480e50e0b0be`

Latest Octet receipt refs: artifact import `blake3:96de132cbcd326b26d4213b71fb312750748b206192f082a945fa6903a06a0ed`; strict gate pass `blake3:19da34de5895c187b62573dc3ba501f85ebff368f09a0095ab1d75641d01430d`; remediation plan `blake3:92573e77140a3ea65799efbed7d38ddfac39d9a941265b06f4ac480e50e0b0be`.
...
| workspace/focused | `target/octet/object-corpus-receipt.json` | `blake3:092aa9c08018a9c310ad599f41dd4cddcfb89dda67ffdd2019130032b49b8876` |
...
| workspace/import | `target/octet/artifact-ledger-receipt.preserves` | `blake3:96de132cbcd326b26d4213b71fb312750748b206192f082a945fa6903a06a0ed` |
| workspace/gate | `target/octet/gate-receipt.preserves` | `blake3:19da34de5895c187b62573dc3ba501f85ebff368f09a0095ab1d75641d01430d` |
| workspace/plan | `target/octet/remediation-plan.preserves` | `blake3:92573e77140a3ea65799efbed7d38ddfac39d9a941265b06f4ac480e50e0b0be` |

Focused object corpus: object-set hash `b3:48393339dc4e1c31e42c5a963d7785f28a65885be54350b85b5d21df89c7c34c`, 2905 objects, 2905 pure-cache blocked, source paths include `src/cli/core/artifact.rs`, `src/cli/core/cache.rs`, `src/cli/core/catalog.rs`, `src/cli/core/catalog/filter.rs`, `src/cli/core/chunk.rs`, `src/cli/core/chunk/io.rs`, `src/cli/workflow/coordination.rs`, `src/cli/workflow/coordination/bounded.rs`, `src/cli/workflow/delivery.rs`, `src/cli/ops/dogfood.rs`, `src/cli/ops/dogfood/archive.rs`, `src/cli/ops/dogfood/command.rs`, `src/cli/ops/dogfood/signed.rs`, `src/cli/evidence/gate.rs`, `src/cli/test/harness.rs`, `src/cli/workflow/job.rs`, `src/cli/ops/ledger.rs`, `src/cli/ops/node.rs`, `src/cli/ops/nixosvm.rs`, `src/cli/ops/octet.rs`, `src/cli/ops/octet/baseline.rs`, `src/cli/ops/plugin.rs`, `src/cli/evidence/receipts.rs`, `src/cli/ops/prodsoak.rs`, `src/cli/ops/prodsoak/command.rs`, `src/cli/workflow/protocol.rs`, `src/cli/workflow/provenance.rs`, `src/cli/workflow/provenance/input.rs`, `src/cli/runtime/raft.rs`, `src/cli/workflow/remote.rs`, `src/cli/test/replayfixture.rs`, `src/cli/evidence/report.rs`, `src/cli/runtime/repro.rs`, `src/cli/workflow/retention.rs`, `src/cli/runtime/rewrite.rs`, `src/cli/runtime/rewrite/input.rs`, `src/cli/core/schema.rs`, `src/cli/runtime/secrets.rs`, `src/cli/runtime/service.rs`, `src/cli/core/storage.rs`, `src/cli/core/transcript.rs`, `src/cli/runtime/upgrade.rs`, `src/cli/runtime/vat.rs`, `src/prod/soak.rs`, `src/runtime/envelope/mod.rs`, `src/runtime/envelope/tests.rs`, `src/nixos/tests.rs`, and `src/octet/remediation.rs` plus the critical runtime, node, job, retention, secrets, protocol, catalog, and CLI paths listed in `target/octet/object-corpus-receipt.json`.
