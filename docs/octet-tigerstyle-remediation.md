...
Plan ref: `blake3:fd37dc186c7d4162dc17d07a9ea4b16eca3797c919d48cca3673a4da536984c8`

Latest Octet receipt refs: artifact import `blake3:74691dba507965792d333f8fadbd6530d3dfeb686cb384a6b32dd326d466f510`; strict gate pass `blake3:cb8fac1dd8145230aac92e5e6b7b2933633088a94863c8c63168b2cf30483866`; remediation plan `blake3:fd37dc186c7d4162dc17d07a9ea4b16eca3797c919d48cca3673a4da536984c8`.
...
| workspace/focused | `target/octet/object-corpus-receipt.json` | `blake3:b293242a692fba35384ad5c435bfe0660f6613307dd356f109422a5fd203a7bc` |
...
| workspace/import | `target/octet/artifact-ledger-receipt.preserves` | `blake3:74691dba507965792d333f8fadbd6530d3dfeb686cb384a6b32dd326d466f510` |
| workspace/gate | `target/octet/gate-receipt.preserves` | `blake3:cb8fac1dd8145230aac92e5e6b7b2933633088a94863c8c63168b2cf30483866` |
| workspace/plan | `target/octet/remediation-plan.preserves` | `blake3:fd37dc186c7d4162dc17d07a9ea4b16eca3797c919d48cca3673a4da536984c8` |

Focused object corpus: object-set hash `b3:818135b099139653a87e9148c42e42711a89016850bb228e0c26fd536412ec2e`, 2870 objects, 2870 pure-cache blocked, source paths include `src/cli_artifact.rs`, `src/cli_cache.rs`, `src/cli_catalog.rs`, `src/cli_chunk.rs`, `src/cli_coordination.rs`, `src/cli_delivery.rs`, `src/cli_dogfood.rs`, `src/cli_gate.rs`, `src/cli_harness.rs`, `src/cli_job.rs`, `src/cli_ledger.rs`, `src/cli_node.rs`, `src/cli_nixos_vm.rs`, `src/cli_octet.rs`, `src/cli_plugin.rs`, `src/cli_receipts.rs`, `src/cli_prod_soak.rs`, `src/cli_protocol.rs`, `src/cli_provenance.rs`, `src/cli_raft.rs`, `src/cli_remote.rs`, `src/cli_replay_fixture.rs`, `src/cli_report.rs`, `src/cli_repro.rs`, `src/cli_retention.rs`, `src/cli_rewrite.rs`, `src/cli_schema.rs`, `src/cli_secrets.rs`, `src/cli_service.rs`, `src/cli_storage.rs`, `src/cli_transcript.rs`, `src/cli_upgrade.rs`, `src/cli_vat.rs`, `src/prod_soak.rs`, and `src/octet_remediation.rs` plus the critical runtime, node, job, retention, secrets, protocol, catalog, and CLI paths listed in `target/octet/object-corpus-receipt.json`.
...
| cli-artifact-output | `src/main.rs`, `src/cli_artifact.rs`, `src/cli_cache.rs`, `src/cli_catalog.rs`, `src/cli_chunk.rs`, `src/cli_coordination.rs`, `src/cli_delivery.rs`, `src/cli_dogfood.rs`, `src/cli_gate.rs`, `src/cli_harness.rs`, `src/cli_job.rs`, `src/cli_ledger.rs`, `src/cli_nixos_vm.rs`, `src/cli_node.rs`, `src/cli_octet.rs`, `src/cli_plugin.rs`, `src/cli_receipts.rs`, `src/cli_prod_soak.rs`, `src/cli_protocol.rs`, `src/cli_provenance.rs`, `src/cli_raft.rs`, `src/cli_remote.rs`, `src/cli_replay_fixture.rs`, `src/cli_report.rs`, `src/cli_repro.rs`, `src/cli_retention.rs`, `src/cli_rewrite.rs`, `src/cli_schema.rs`, `src/cli_secrets.rs`, `src/cli_service.rs`, `src/cli_storage.rs`, `src/cli_transcript.rs`, `src/cli_upgrade.rs`, `src/cli_vat.rs` | 0 | 0 |

## Burn-down order if source-remediated zero is required

Active burn-down slice: `cairn/changes/octet-source-remediated-zero` has moved Octet, Delivery, Protocol, Provenance, Retention, Job, Secrets, Plugin, Node, Repro, Catalog, Chunk, Cache, Artifact, Storage, Schema, Upgrade, Transcript, Rewrite, Remote, Ledger, Chain, Receipts, test Receipt, Service, Vat, Coordination, Dogfood, Raft, replay-fixture, Report, Gate, and harness run/replay CLI handling out of `src/main.rs` into `src/cli_octet.rs`, `src/cli_delivery.rs`, `src/cli_protocol.rs`, `src/cli_provenance.rs`, `src/cli_retention.rs`, `src/cli_job.rs`, `src/cli_secrets.rs`, `src/cli_plugin.rs`, `src/cli_node.rs`, `src/cli_prod_soak.rs`, `src/cli_repro.rs`, `src/cli_catalog.rs`, `src/cli_chunk.rs`, `src/cli_cache.rs`, `src/cli_artifact.rs`, `src/cli_storage.rs`, `src/cli_schema.rs`, `src/cli_upgrade.rs`, `src/cli_transcript.rs`, `src/cli_rewrite.rs`, `src/cli_remote.rs`, `src/cli_ledger.rs`, `src/cli_receipts.rs`, `src/cli_service.rs`, `src/cli_vat.rs`, `src/cli_coordination.rs`, `src/cli_dogfood.rs`, `src/cli_gate.rs`, `src/cli_harness.rs`, `src/cli_raft.rs`, `src/cli_replay_fixture.rs`, and `src/cli_report.rs` while preserving command semantics. The broader state remains configuration-clean until disabled lint families are removed or narrowed and evidence is refreshed.
