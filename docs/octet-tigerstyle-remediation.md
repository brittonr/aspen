...
Plan ref: `blake3:45417579610c7e2205d845e8efe1c9a924ac5b7146702e169b037db35b87b476`

Latest Octet receipt refs: artifact import `blake3:b506cf45f741d29c23d1f344322e36bcd15298139da985d93f981283900d506a`; strict gate pass `blake3:f85cb277f0cf63b2aead3550ed0273241a2c163c0798d238b0b9f5e30febec70`; remediation plan `blake3:45417579610c7e2205d845e8efe1c9a924ac5b7146702e169b037db35b87b476`.
...
| workspace/focused | `target/octet/object-corpus-receipt.json` | `blake3:c1eab50a91a1fa05b7a3c375dd0dba62e6339c088755c084dc1de4f30de50f05` |
...
| workspace/import | `target/octet/artifact-ledger-receipt.preserves` | `blake3:b506cf45f741d29c23d1f344322e36bcd15298139da985d93f981283900d506a` |
| workspace/gate | `target/octet/gate-receipt.preserves` | `blake3:f85cb277f0cf63b2aead3550ed0273241a2c163c0798d238b0b9f5e30febec70` |
| workspace/plan | `target/octet/remediation-plan.preserves` | `blake3:45417579610c7e2205d845e8efe1c9a924ac5b7146702e169b037db35b87b476` |

Focused object corpus: object-set hash `b3:cfb8c40c183386ced48f4f76c9ec585d91b859edd25db73de06f5df281a82001`, 2850 objects, 2850 pure-cache blocked, source paths include `src/cli_artifact.rs`, `src/cli_cache.rs`, `src/cli_catalog.rs`, `src/cli_chunk.rs`, `src/cli_coordination.rs`, `src/cli_delivery.rs`, `src/cli_job.rs`, `src/cli_ledger.rs`, `src/cli_node.rs`, `src/cli_nixos_vm.rs`, `src/cli_octet.rs`, `src/cli_plugin.rs`, `src/cli_receipts.rs`, `src/cli_prod_soak.rs`, `src/cli_protocol.rs`, `src/cli_provenance.rs`, `src/cli_remote.rs`, `src/cli_repro.rs`, `src/cli_retention.rs`, `src/cli_rewrite.rs`, `src/cli_schema.rs`, `src/cli_secrets.rs`, `src/cli_service.rs`, `src/cli_storage.rs`, `src/cli_transcript.rs`, `src/cli_upgrade.rs`, `src/cli_vat.rs`, `src/prod_soak.rs`, and `src/octet_remediation.rs` plus the critical runtime, node, job, retention, secrets, protocol, catalog, and CLI paths listed in `target/octet/object-corpus-receipt.json`.
...
| cli-artifact-output | `src/main.rs`, `src/cli_artifact.rs`, `src/cli_cache.rs`, `src/cli_catalog.rs`, `src/cli_chunk.rs`, `src/cli_coordination.rs`, `src/cli_delivery.rs`, `src/cli_job.rs`, `src/cli_ledger.rs`, `src/cli_nixos_vm.rs`, `src/cli_node.rs`, `src/cli_octet.rs`, `src/cli_plugin.rs`, `src/cli_receipts.rs`, `src/cli_prod_soak.rs`, `src/cli_protocol.rs`, `src/cli_provenance.rs`, `src/cli_remote.rs`, `src/cli_repro.rs`, `src/cli_retention.rs`, `src/cli_rewrite.rs`, `src/cli_schema.rs`, `src/cli_secrets.rs`, `src/cli_service.rs`, `src/cli_storage.rs`, `src/cli_transcript.rs`, `src/cli_upgrade.rs`, `src/cli_vat.rs` | 0 | 0 |

## Burn-down order if source-remediated zero is required

Active burn-down slice: `cairn/changes/octet-source-remediated-zero` has moved Octet, Delivery, Protocol, Provenance, Retention, Job, Secrets, Plugin, Node, Repro, Catalog, Chunk, Cache, Artifact, Storage, Schema, Upgrade, Transcript, Rewrite, Remote, Ledger, Chain, Receipts, Service, Vat, and Coordination CLI command parsing out of `src/main.rs` into `src/cli_octet.rs`, `src/cli_delivery.rs`, `src/cli_protocol.rs`, `src/cli_provenance.rs`, `src/cli_retention.rs`, `src/cli_job.rs`, `src/cli_secrets.rs`, `src/cli_plugin.rs`, `src/cli_node.rs`, `src/cli_prod_soak.rs`, `src/cli_repro.rs`, `src/cli_catalog.rs`, `src/cli_chunk.rs`, `src/cli_cache.rs`, `src/cli_artifact.rs`, `src/cli_storage.rs`, `src/cli_schema.rs`, `src/cli_upgrade.rs`, `src/cli_transcript.rs`, `src/cli_rewrite.rs`, `src/cli_remote.rs`, `src/cli_ledger.rs`, `src/cli_receipts.rs`, `src/cli_service.rs`, `src/cli_vat.rs`, and `src/cli_coordination.rs` while preserving command semantics. The broader state remains configuration-clean until disabled lint families are removed or narrowed and evidence is refreshed.
