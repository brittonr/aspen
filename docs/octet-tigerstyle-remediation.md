...
Plan ref: `blake3:b36be71e0b047c3d15173a7e0946009a65aeba8459eec756e3901bb28d70b505`

Latest Octet receipt refs: artifact import `blake3:f1c9a8b47ec73044d4b448fa8df92647286f4f60071df3beecb381ea11c1798e`; strict gate pass `blake3:70bf3ac04c38359a34d169b3c63dbec33ed8bcc80526ec3f0d4683f183d84e20`; remediation plan `blake3:b36be71e0b047c3d15173a7e0946009a65aeba8459eec756e3901bb28d70b505`.
...
| workspace/focused | `target/octet/object-corpus-receipt.json` | `blake3:db6108664a9f82c496d760d2eb900966d62e1f6da4e90aceda72d9ed3c6bb359` |
...
| workspace/import | `target/octet/artifact-ledger-receipt.preserves` | `blake3:f1c9a8b47ec73044d4b448fa8df92647286f4f60071df3beecb381ea11c1798e` |
| workspace/gate | `target/octet/gate-receipt.preserves` | `blake3:70bf3ac04c38359a34d169b3c63dbec33ed8bcc80526ec3f0d4683f183d84e20` |
| workspace/plan | `target/octet/remediation-plan.preserves` | `blake3:b36be71e0b047c3d15173a7e0946009a65aeba8459eec756e3901bb28d70b505` |

Focused object corpus: object-set hash `b3:d77e31cc509079d34a680c2507bfc61e5d1eaee828747184cd8467ae3e42bfb6`, 2870 objects, 2870 pure-cache blocked, source paths include `src/cli_artifact.rs`, `src/cli_cache.rs`, `src/cli_catalog.rs`, `src/cli_chunk.rs`, `src/cli_coordination.rs`, `src/cli_delivery.rs`, `src/cli_dogfood.rs`, `src/cli/gate.rs`, `src/cli/harness.rs`, `src/cli_job.rs`, `src/cli_ledger.rs`, `src/cli_node.rs`, `src/cli_nixos_vm.rs`, `src/cli_octet.rs`, `src/cli_plugin.rs`, `src/cli/receipts.rs`, `src/cli_prod_soak.rs`, `src/cli_protocol.rs`, `src/cli_provenance.rs`, `src/cli_raft.rs`, `src/cli_remote.rs`, `src/cli/replayfixture.rs`, `src/cli/report.rs`, `src/cli_repro.rs`, `src/cli_retention.rs`, `src/cli_rewrite.rs`, `src/cli_schema.rs`, `src/cli_secrets.rs`, `src/cli_service.rs`, `src/cli_storage.rs`, `src/cli_transcript.rs`, `src/cli_upgrade.rs`, `src/cli_vat.rs`, `src/prod_soak.rs`, and `src/octet_remediation.rs` plus the critical runtime, node, job, retention, secrets, protocol, catalog, and CLI paths listed in `target/octet/object-corpus-receipt.json`.
...
| cli-artifact-output | `src/main.rs`, `src/cli_artifact.rs`, `src/cli_cache.rs`, `src/cli_catalog.rs`, `src/cli_chunk.rs`, `src/cli_coordination.rs`, `src/cli_delivery.rs`, `src/cli_dogfood.rs`, `src/cli/gate.rs`, `src/cli/harness.rs`, `src/cli_job.rs`, `src/cli_ledger.rs`, `src/cli_nixos_vm.rs`, `src/cli_node.rs`, `src/cli_octet.rs`, `src/cli_plugin.rs`, `src/cli/receipts.rs`, `src/cli_prod_soak.rs`, `src/cli_protocol.rs`, `src/cli_provenance.rs`, `src/cli_raft.rs`, `src/cli_remote.rs`, `src/cli/replayfixture.rs`, `src/cli/report.rs`, `src/cli_repro.rs`, `src/cli_retention.rs`, `src/cli_rewrite.rs`, `src/cli_schema.rs`, `src/cli_secrets.rs`, `src/cli_service.rs`, `src/cli_storage.rs`, `src/cli_transcript.rs`, `src/cli_upgrade.rs`, `src/cli_vat.rs` | 0 | 0 |

## Burn-down order if source-remediated zero is required

Active burn-down slice: `cairn/changes/octet-source-remediated-zero` has moved Octet, Delivery, Protocol, Provenance, Retention, Job, Secrets, Plugin, Node, Repro, Catalog, Chunk, Cache, Artifact, Storage, Schema, Upgrade, Transcript, Rewrite, Remote, Ledger, Chain, Receipts, test Receipt, Service, Vat, Coordination, Dogfood, Raft, replay-fixture, Report, Gate, and harness run/replay CLI handling out of `src/main.rs`, then relocated the recent Gate, Harness, Receipts, replay-fixture, and Report shells under `src/cli/` (`src/cli/gate.rs`, `src/cli/harness.rs`, `src/cli/receipts.rs`, `src/cli/replayfixture.rs`, `src/cli/report.rs`) to narrow root module-count and underscore-filename pressure while preserving command semantics. The broader state remains configuration-clean until disabled lint families are removed or narrowed and evidence is refreshed.
