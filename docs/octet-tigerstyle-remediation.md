...
Plan ref: `blake3:cb519fdc7a6c5b220008f7ec441a0cdd100c1fb9b5290819800e89bb9506505d`

Latest Octet receipt refs: artifact import `blake3:171c35c207ea471668fe930b05d389575b97b3694a82c601e29472ca364a604c`; strict gate pass `blake3:0a3ef71392b5476db203c44ac1f061dbc22baa59d8f62bb79233990436e11882`; remediation plan `blake3:cb519fdc7a6c5b220008f7ec441a0cdd100c1fb9b5290819800e89bb9506505d`.
...
| workspace/focused | `target/octet/object-corpus-receipt.json` | `blake3:a74d597672515f7426b0c659ca08989766da48a0debbaeda68c487a1a2541fa5` |
...
| workspace/import | `target/octet/artifact-ledger-receipt.preserves` | `blake3:171c35c207ea471668fe930b05d389575b97b3694a82c601e29472ca364a604c` |
| workspace/gate | `target/octet/gate-receipt.preserves` | `blake3:0a3ef71392b5476db203c44ac1f061dbc22baa59d8f62bb79233990436e11882` |
| workspace/plan | `target/octet/remediation-plan.preserves` | `blake3:cb519fdc7a6c5b220008f7ec441a0cdd100c1fb9b5290819800e89bb9506505d` |

Focused object corpus: object-set hash `b3:5e7bba36fa4ec41bcc90fe49884d7c5513f1dd677d733e18db891e00131db4f6`, 2905 objects, 2905 pure-cache blocked, source paths include `src/cli/core/artifact.rs`, `src/cli/core/cache.rs`, `src/cli/core/catalog.rs`, `src/cli/core/catalog/filter.rs`, `src/cli/core/chunk.rs`, `src/cli/core/chunk/io.rs`, `src/cli/workflow/coordination.rs`, `src/cli/workflow/coordination/bounded.rs`, `src/cli/workflow/delivery.rs`, `src/cli/ops/dogfood.rs`, `src/cli/evidence/gate.rs`, `src/cli/test/harness.rs`, `src/cli/workflow/job.rs`, `src/cli/ops/ledger.rs`, `src/cli/ops/node.rs`, `src/cli/ops/nixosvm.rs`, `src/cli/ops/octet.rs`, `src/cli/ops/octet/baseline.rs`, `src/cli/ops/plugin.rs`, `src/cli/evidence/receipts.rs`, `src/cli/ops/prodsoak.rs`, `src/cli/ops/prodsoak/command.rs`, `src/cli/workflow/protocol.rs`, `src/cli/workflow/provenance.rs`, `src/cli/workflow/provenance/input.rs`, `src/cli/runtime/raft.rs`, `src/cli/workflow/remote.rs`, `src/cli/test/replayfixture.rs`, `src/cli/evidence/report.rs`, `src/cli/runtime/repro.rs`, `src/cli/workflow/retention.rs`, `src/cli/runtime/rewrite.rs`, `src/cli/runtime/rewrite/input.rs`, `src/cli/core/schema.rs`, `src/cli/runtime/secrets.rs`, `src/cli/runtime/service.rs`, `src/cli/core/storage.rs`, `src/cli/core/transcript.rs`, `src/cli/runtime/upgrade.rs`, `src/cli/runtime/vat.rs`, `src/prod/soak.rs`, `src/runtime/envelope/mod.rs`, `src/runtime/envelope/tests.rs`, `src/nixos/tests.rs`, and `src/octet/remediation.rs` plus the critical runtime, node, job, retention, secrets, protocol, catalog, and CLI paths listed in `target/octet/object-corpus-receipt.json`.
