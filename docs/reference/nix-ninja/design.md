# nix-ninja Design Notes

> Source: https://github.com/pdtpartners/nix-ninja/blob/main/docs/design.md
...
build src/libutil/libnixutil.so.p/archive.cc.o: cpp_COMPILER ../src/libutil/archive.cc
 ...
 ARGS = -Isrc/libutil/libnixutil.so.p ... -I/nix/store/47zbszclyyy55nb5z7dvpcki4x5g99v4-libarchive-3.7.7-dev/include ...
```
