...
- `operator-dogfood-nix-release-check` — Nix release check that depends on hermetic nextest, runs `molten dogfood local-node`, and preserves report/gate artifacts as evidence-only review outputs.
