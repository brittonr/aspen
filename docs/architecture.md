...
- `retention-gc-pinning` — retention classes, pin sources, reference indexes, tombstones, redaction hooks, per-remote GC clearance, and safe GC eligibility.
