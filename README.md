...
The strict gate is fail-closed: `warning-only` denies even when `cargo-octet` exits `0`, and `command.txt`, `status.json`, `summary.txt`, structured finding keys, object corpus receipts, and fingerprint evidence are bound by canonical refs in the Octet receipt. Current remediation snapshot: workspace and lib-only Octet are `clean` with 0 findings, 0 warnings, and 0 errors; focused object corpus has 2857 objects (`b3:ea86f5b3933807b4827c5e2bccccafc1c2f2255beb6f43025f20517dad9e8f16`); latest artifact import receipt is `blake3:238d46562850772a59c675bc256c7a3cd29659efd15aace352e35bba92166944`, latest strict pass receipt is `blake3:6b616b1c9283d9dcef6b1fff3eaf1d2343da9e4afbbbecf886effcd6978d276a`, and latest remediation plan receipt is `blake3:dd2c2c1f6519932ec4974cb16fcbd1b77e60680f4fa3387cc04735376bea1041`. Caveat: this is configuration-clean with the broad high-noise lint families explicitly disabled in `dylint.toml`; source-remediated zero for those disabled families remains separate follow-up work. Nix/dogfood was not rerun for the Replay-fixture-only disabled-lint burn-down slice. During warning burn-down only, use the explicit quarantine flow:
