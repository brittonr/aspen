...
cargo octet object corpus receipt \
  ...
  src/chunk_store.rs src/cli_artifact.rs src/cli_cache.rs src/cli_catalog.rs src/cli_chunk.rs src/cli_coordination.rs src/cli_delivery.rs src/cli_dogfood.rs src/cli_gate.rs src/cli_job.rs src/cli_ledger.rs src/cli_node.rs src/cli_receipts.rs src/cli_nixos_vm.rs src/cli_octet.rs src/cli_plugin.rs src/cli_prod_soak.rs src/cli_protocol.rs src/cli_provenance.rs src/cli_raft.rs src/cli_remote.rs src/cli_report.rs src/cli_replay_fixture.rs src/cli_repro.rs src/cli_retention.rs src/cli_rewrite.rs src/cli_schema.rs src/cli_secrets.rs src/cli_service.rs src/cli_storage.rs src/cli_transcript.rs src/cli_upgrade.rs src/cli_vat.rs src/coordination.rs src/delivery_idempotency.rs \
  ...
  src/prod_soak.rs src/protocol_session.rs src/provenance.rs src/raft_control_plane.rs \
...
The strict gate is fail-closed: `warning-only` denies even when `cargo-octet` exits `0`, and `command.txt`, `status.json`, `summary.txt`, structured finding keys, object corpus receipts, and fingerprint evidence are bound by canonical refs in the Octet receipt. Current remediation snapshot: workspace and lib-only Octet are `clean` with 0 findings, 0 warnings, and 0 errors; focused object corpus has 2867 objects (`b3:b2d4a118b7f2c4910a84cea5a9a481da7ac323192e21354c1b22a6c3139fe631`); latest artifact import receipt is `blake3:8ee62c8ce7b7442effc70feac1e3d41b7140511147dbebb383f819dea3135766`, latest strict pass receipt is `blake3:fabea773aeabf5fb1d79cf0fb062918b3e557869969b4c379dd4678c81607a0c`, and latest remediation plan receipt is `blake3:4df965a9f47f7a63148edc1bb7f45074f8776f98cd578a99355a58ae367482c8`. Caveat: this is configuration-clean with the broad high-noise lint families explicitly disabled in `dylint.toml`; source-remediated zero for those disabled families remains separate follow-up work. Nix/dogfood was not rerun for the Receipt-only disabled-lint burn-down slice. During warning burn-down only, use the explicit quarantine flow:
