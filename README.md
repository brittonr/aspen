...
cargo octet object corpus receipt \
  ...
  src/chunk_store.rs src/cli_artifact.rs src/cli_cache.rs src/cli_catalog.rs src/cli_chunk.rs src/cli_coordination.rs src/cli_delivery.rs src/cli_dogfood.rs src/cli/gate.rs src/cli/harness.rs src/cli_job.rs src/cli_ledger.rs src/cli_node.rs src/cli/receipts.rs src/cli_nixos_vm.rs src/cli_octet.rs src/cli_plugin.rs src/cli_prod_soak.rs src/cli_protocol.rs src/cli_provenance.rs src/cli_raft.rs src/cli_remote.rs src/cli/report.rs src/cli/replayfixture.rs src/cli_repro.rs src/cli_retention.rs src/cli_rewrite.rs src/cli_schema.rs src/cli_secrets.rs src/cli_service.rs src/cli_storage.rs src/cli_transcript.rs src/cli_upgrade.rs src/cli_vat.rs src/coordination.rs src/delivery_idempotency.rs \
...
The strict gate is fail-closed: `warning-only` denies even when `cargo-octet` exits `0`, and `command.txt`, `status.json`, `summary.txt`, structured finding keys, object corpus receipts, and fingerprint evidence are bound by canonical refs in the Octet receipt. Current remediation snapshot: workspace and lib-only Octet are `clean` with 0 findings, 0 warnings, and 0 errors; focused object corpus has 2870 objects (`b3:d77e31cc509079d34a680c2507bfc61e5d1eaee828747184cd8467ae3e42bfb6`); latest artifact import receipt is `blake3:f1c9a8b47ec73044d4b448fa8df92647286f4f60071df3beecb381ea11c1798e`, latest strict pass receipt is `blake3:70bf3ac04c38359a34d169b3c63dbec33ed8bcc80526ec3f0d4683f183d84e20`, and latest remediation plan receipt is `blake3:b36be71e0b047c3d15173a7e0946009a65aeba8459eec756e3901bb28d70b505`. Caveat: this is configuration-clean with the broad high-noise lint families explicitly disabled in `dylint.toml`; source-remediated zero for those disabled families remains separate follow-up work. Nix/dogfood was not rerun for the CLI-directory disabled-lint burn-down slice. During warning burn-down only, use the explicit quarantine flow:
