...
The strict gate is fail-closed: `warning-only` denies even when `cargo-octet` exits `0`, and `command.txt`, `status.json`, `summary.txt`, structured finding keys, object corpus receipts, and fingerprint evidence are bound by canonical refs in the Octet receipt. Current remediation snapshot: workspace and lib-only Octet are `clean` with 0 findings, 0 warnings, and 0 errors; focused object corpus has 2867 objects (`b3:a1778404c45c18c230f4290b9cdf8c6bc03de2ec2f8ec559d0589bac93be591d`); latest artifact import receipt is `blake3:e25a10dd87370b84ac3f5b397e4fc92f6d34f522face628805e3ec0315784c8c`, latest strict pass receipt is `blake3:a3824bbe36fd744ca0af2484e9f8c9f9fa17748b008b5132404de44920cd6392`, and latest remediation plan receipt is `blake3:00256eb7b24a91fcb8e1b33c18f0469dd800908d7e1dbbfc8303b4143099d78b`. Caveat: this is configuration-clean with the broad high-noise lint families explicitly disabled in `dylint.toml`; source-remediated zero for those disabled families remains separate follow-up work. Nix/dogfood was not rerun for the Gate-only disabled-lint burn-down slice. During warning burn-down only, use the explicit quarantine flow:
