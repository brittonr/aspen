...
The node daemon's capability-rooted lifecycle, identity, queue, ingress, nested-store, and async authority boundary is documented in [`docs/node-state-filesystem-authority.md`](docs/node-state-filesystem-authority.md).
