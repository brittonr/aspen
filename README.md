...
cargo octet object corpus receipt \
  ...
  src/chunk_store.rs src/cli_artifact.rs src/cli_cache.rs src/cli_catalog.rs src/cli_chunk.rs src/cli_coordination.rs src/cli_delivery.rs src/cli_job.rs src/cli_ledger.rs src/cli_node.rs src/cli_receipts.rs src/cli_nixos_vm.rs src/cli_octet.rs src/cli_plugin.rs src/cli_prod_soak.rs src/cli_protocol.rs src/cli_provenance.rs src/cli_remote.rs src/cli_repro.rs src/cli_retention.rs src/cli_rewrite.rs src/cli_schema.rs src/cli_secrets.rs src/cli_service.rs src/cli_storage.rs src/cli_transcript.rs src/cli_upgrade.rs src/cli_vat.rs src/coordination.rs src/delivery_idempotency.rs \
...
The strict gate is fail-closed: `warning-only` denies even when `cargo-octet` exits `0`, and `command.txt`, `status.json`, `summary.txt`, structured finding keys, object corpus receipts, and fingerprint evidence are bound by canonical refs in the Octet receipt. Current remediation snapshot: workspace and lib-only Octet are `clean` with 0 findings, 0 warnings, and 0 errors; focused object corpus has 2850 objects (`b3:cfb8c40c183386ced48f4f76c9ec585d91b859edd25db73de06f5df281a82001`); latest artifact import receipt is `blake3:b506cf45f741d29c23d1f344322e36bcd15298139da985d93f981283900d506a`, latest strict pass receipt is `blake3:f85cb277f0cf63b2aead3550ed0273241a2c163c0798d238b0b9f5e30febec70`, and latest remediation plan receipt is `blake3:45417579610c7e2205d845e8efe1c9a924ac5b7146702e169b037db35b87b476`. Caveat: this is configuration-clean with the broad high-noise lint families explicitly disabled in `dylint.toml`; source-remediated zero for those disabled families remains separate follow-up work. Nix/dogfood was not rerun for the Coordination-only disabled-lint burn-down slice. During warning burn-down only, use the explicit quarantine flow:
