...
See [`docs/architecture.md`](docs/architecture.md) for the fuller architecture. See [`docs/nominal-authority-references.md`](docs/nominal-authority-references.md) for typed authority and artifact reference domains, Preserves wire admission, compile-time separation, and authority non-claims. See [`docs/fabric-port-ownership.md`](docs/fabric-port-ownership.md) for application-owned fabric ports, typed infrastructure failures, shell effect order, adapter roles, and source enforcement. See [`docs/nickel-toolchain.md`](docs/nickel-toolchain.md) for the pinned Nickel evaluator cohort and product-policy boundary. See [`docs/dataspace-access-cache.md`](docs/dataspace-access-cache.md) for bounded advisory access caching, deterministic retention, deferred release, and authority non-claims. See [`docs/live-artifact-binding-and-semantic-effects.md`](docs/live-artifact-binding-and-semantic-effects.md) for one-snapshot live binding, conservative generation retirement, and exact Kamacite semantic operation adoption. See [`docs/fabric-whole-system-simulation.md`](docs/fabric-whole-system-simulation.md) for bounded same-core simulation, replay, shrinking, reference services, and claim profiles. See [`docs/dag-sync.md`](docs/dag-sync.md) for bounded receiver-driven graph synchronization, resume fencing, and live/simulation conformance. See [`docs/distributed-system-fabric.md`](docs/distributed-system-fabric.md) for the primitive, adapter, system-extension, and workload ownership boundary. See [`docs/system-extension-runtime.md`](docs/system-extension-runtime.md) for executable system-extension manifests, lifecycle, generation fencing, supervision, typed fabric effects, and operator evidence. See [`docs/fabric-time-scheduler-runtime.md`](docs/fabric-time-scheduler-runtime.md) for typed time domains, generation-fenced timers, bounded runnable scheduling, purpose-bound entropy, deadlines, local lease decisions, and live/virtual adapter conformance. See [`docs/fabric-transport-session-runtime.md`](docs/fabric-transport-session-runtime.md) for extension-owned protocol registration, capability-bound cross-process endpoint handoff, generation-fenced listeners/sessions/streams, typed effect-port routing, receipt-first two-process conformance, bounded framing and flow control, identity separation, live Iroh/simulation parity, and explicit connectivity/delivery non-claims. See [`docs/fabric-membership-placement.md`](docs/fabric-membership-placement.md) for source-scoped membership views, bounded failure observations, deterministic placement, role recruitment, profile-scoped fencing, drain/replacement, and live/simulation provider parity. See [`docs/fabric-cryptographic-identity.md`](docs/fabric-cryptographic-identity.md) for opaque purpose-scoped keys, Ed25519/Iroh production adapters, canonical signatures, generation-fenced rotation, redacted readback, and fixture-only BLAKE3 boundaries. See [`docs/fabric-observability.md`](docs/fabric-observability.md) for bounded canonical metrics and events, scoped health/readiness, exporter failure semantics, redaction, and read-only integrity scans. See [`docs/content-store-adapter.md`](docs/content-store-adapter.md) for primitive-owned content identity, bounded local/Redb/live-Iroh/simulation adapters, verified partial state, and protection non-authority. See [`docs/content-replication.md`](docs/content-replication.md) for explicit replica policy, fenced repair, retention, and same-core conformance. See [`docs/syndicate-reference-harness.md`](docs/syndicate-reference-harness.md) for the Syndicate reference-semantics boundary. See [`docs/local-filesystem-authority.md`](docs/local-filesystem-authority.md) for the local capability-root filesystem boundary. See [`docs/choreography-typed-facade.md`](docs/choreography-typed-facade.md) for the ChoRus-inspired typed-facade boundary. See [`docs/effect-manifest-profiles.md`](docs/effect-manifest-profiles.md) for the Unison-inspired effect manifest/profile boundary. See [`docs/unison-reference-execution.md`](docs/unison-reference-execution.md) for the artifact-ref remote execution boundary. See [`docs/plugin-lifecycle-fsm.md`](docs/plugin-lifecycle-fsm.md) for the explicit plugin lifecycle FSM boundary. See [`docs/iroh-alpn-routing-registry.md`](docs/iroh-alpn-routing-registry.md) for the canonical Iroh ALPN routing registry boundary. See [`docs/rkyv-derived-cache-boundary.md`](docs/rkyv-derived-cache-boundary.md) for the rkyv-derived cache and typed-storage sidecar boundary. See [`docs/peer-session-transition-relation.md`](docs/peer-session-transition-relation.md) for the reviewed peer-session FSM boundary. See [`docs/replay-coverage-readiness.md`](docs/replay-coverage-readiness.md) for replay coverage/readiness matrices. See [`docs/replay-effect-log-hardening.md`](docs/replay-effect-log-hardening.md) for replay effect-log ordering and binding validation. See [`docs/replay-identity-freshness.md`](docs/replay-identity-freshness.md) for release-bound replay identity freshness checks. See [`docs/replay-multiturn-explain.md`](docs/replay-multiturn-explain.md) for multi-turn replay compare/explain diagnostics. See [`docs/runtime-limit-profiles.md`](docs/runtime-limit-profiles.md) for reviewed runtime budget admission under hard caps. See [`docs/ast-grep-runtime-authority-audits.md`](docs/ast-grep-runtime-authority-audits.md) for ast-grep structural authority audits and blocking regression gates. See [`docs/verified-node-replication-pilot.md`](docs/verified-node-replication-pilot.md) for the blocked local NUMA node-replication compatibility pilot, revision-pinned Octet verifier-package provenance, and trusted-boundary audit.

The product-owned world-commit protocol is documented in [`docs/world-commit.md`](docs/world-commit.md). It defines typed roots, canonical identity, fenced local capture, closure checks, restore planning, detached evidence, and explicit non-claims.
...
Preview-first operator composition is documented in [`docs/world-operator-workflows.md`](docs/world-operator-workflows.md). The typed workflow orders component handlers, rechecks every mutation, reports the first blocker, and links receipts without replacing their owners.

Bounded crash, restart, and concurrency conformance is documented in [`docs/world-fault-conformance.md`](docs/world-fault-conformance.md). The rail keeps a closed mutation inventory, uses semantic fault phases, reopens durable state, and retains unsupported witness rows without granting recovery or cleanup authority.

The optional DoltLite semantic-state oracle is documented in [`docs/doltlite-semantic-state-oracle.md`](docs/doltlite-semantic-state-oracle.md). It compares normalized, bounded test observations from one exact remotes-disabled cohort without granting product authority or proving correctness.

The product-local Prolly semantic-state map is documented in [`docs/prolly-semantic-state-map.md`](docs/prolly-semantic-state-map.md). It provides bounded, history-independent ordered state while storage, branch policy, merge authority, retention, and deletion remain outside the core.

The coordination delivery extension is documented in [`docs/coordination-delivery.md`](docs/coordination-delivery.md). It adds fenced claims, acknowledgements, logical-time retry, dead-letter handling, redrive, restart, and bounded receipts without changing base FIFO semantics or claiming exactly-once effects.

The addressable actor profile is documented in [`docs/addressable-actor-runtime.md`](docs/addressable-actor-runtime.md). It composes keyed sleep, wake, restore, drain, and recovery over existing fabric owners with explicit survival and uncertainty boundaries.
...
`molten test prod-soak` now also emits canonical production readiness receipts for deployment profiles, backup/restore drills, upgrade/rollback drills, observability/SLO snapshots, runbook checks, security threat models, security drills, redaction audits, supply-chain reviews, boundary negative suites, incident response drills, security readiness reports, pilot decisions, and release-candidate gates. A release-candidate gate requires every evidence artifact to declare the same reviewed candidate source. These receipts validate declared identity bindings only; they do not prove external artifact truth or grant authority, policy, provenance, retention, transport, source-gate, destructive-operation, or release trust. A release candidate with only configuration-clean Octet evidence must carry a source-gate caveat and can only support an explicitly scoped pilot decision.
...
For revision-pinned OnixResearch Git dependencies, the flake uses reviewed immutable source inputs. Authentication and binding use one unified Artifact input. Other dependencies retain their accepted transports. Sibling checkouts can be substituted only through explicit development-time `--override-input` paths. The substitution filters generated and VCS-heavy directories such as `target/` and `.git/` before unit2nix sees the source. Release validation compares Cargo manifest, lockfile, Nix, release-policy, and generated-plan identities and rejects local paths as release evidence. See [`docs/reproducible-dependencies.md`](docs/reproducible-dependencies.md). Latest limited-pilot nextest output: `/nix/store/d50qlba4am1pb4f59l71djjg1bl6adhi-molten-nextest`.

The Molten `0.1.0` limited-pilot candidate is commit `a4f111690b6962f04d9320fd93d09c7dd1ad2fd0`. Its source reference is `blake3:80e3ceb18784504c7573191fce72e121d0789613c6c5f7bdcecbdd9ae0e4cdb7`.

The candidate gate passed as `blake3:9d15e7f99a34ba5f1a979d07cd7023025347144349db50caacca6ddbb90ab1e4`. The pilot decision is `blake3:ea03ddbada910b33a09fe3156e9908b2b7c1f1b0c6b14b39570ae05abdaf27cb`.

See [`docs/releases/molten-0.1.0.md`](docs/releases/molten-0.1.0.md) and [`release/molten-0.1.0-pilot.ncl`](release/molten-0.1.0-pilot.ncl) for scope and evidence. Preserved artifacts live with the archived release Cairn. They remain evidence-only and grant no runtime or release authority.
...
The strict gate is fail-closed: `warning-only` denies even when `cargo-octet` exits `0`, and `command.txt`, `status.json`, `summary.txt`, structured finding keys, object corpus receipts, and fingerprint evidence are bound by canonical refs in the Octet receipt. The dev shell provides `cargo-octet` from the catalogued `octet-toolchain` flake input (`OnixResearch/octet` `fc38f59330b626961d166febfdf1a5aa6575460f`, toolchain `nightly-2026-03-21`); an ambient `cargo-octet` elsewhere on `PATH` is not Octet evidence. Current state (2026-09-25, `9e5f6db73` on `integration/stack-20260925`, pinned Octet, `dylint.toml` `disabled_lints = []`): the configured workspace run is `warning-only` with 3209 findings (1761 distinct lint sites: `path_segment_repetition` 1878, `excessive_file_length` 551, `borrowed_argument_types` 368, `function_length` 204, `too_many_parameters` 143, `underscore_in_module_filename` 31, `module_file_count` 20, `ambient_env` 14), and the `-p molten --lib` run is `warning-only` with 1363 findings. Every critical family (`no_unwrap`, `no_panic`, `unbounded_collection_growth`, `ambient_clock`) and `no_recursion`, `unbounded_channel`, `usize_in_public_api`, `non_trait_imports`, and `explicit_defaults` are at zero; the only lint allows added by the burn-down are the two `tigerstyle::ambient_clock` item allows on the documented `LiveClockAdapter` clock capability. The strict gate therefore denies only on status: `no-critical-findings`, `status-config-current`, and `status-profile-current` pass, and `strict-status-clean` fails on the remaining size-shape and path-shape families and the parked `ambient_env` sites. There is still no current clean Octet claim: the 2026-07-02 clean receipt predates later source growth and the pinned tool. The repair plan is a burn-down series modelled on the archived `octet-burndown-*` packages: import hygiene (`non_trait_imports`, `explicit_defaults`), safety polish (the critical families plus `usize_in_public_api`, `unbounded_channel`, `ambient_env`, `no_recursion`), size shape (`excessive_file_length`, `function_length`, `too_many_parameters`, `borrowed_argument_types`), and path shape (`path_segment_repetition`, `underscore_in_module_filename`, `module_file_count`). Hook or CI enforcement that denies `warning-only` lands after the series reaches zero. The quarantine flow below is burn-down tooling only; its example expiry dates have passed, and no baseline or review receipt currently admits these findings. During warning burn-down only, use the explicit quarantine flow:
...
- [`brittonr/aspen` `main`](https://github.com/brittonr/aspen/tree/main) — AGPL-licensed behavior and architecture reference for clean-room requirements and independently expressed conformance tests only; Molten does not copy Aspen implementation code, comments, or fixtures without compatible relicensing.
...
- [`bytecodealliance/cap-std`](https://github.com/bytecodealliance/cap-std) — reference for capability-rooted filesystem and temporary-workspace boundaries; Molten retains its own policy, evidence, durability, and authority semantics and does not treat `cap-std` as a sandbox for untrusted Rust code.
- [`bytecodealliance/sightglass` at `c18bbe75803a6a610f7ff3b15549c927c6e02667`](https://github.com/bytecodealliance/sightglass/tree/c18bbe75803a6a610f7ff3b15549c927c6e02667) — pinned CLI and raw-measurement-schema reference for recorded-only Wasm component performance experiments; its results do not transfer correctness, security, authority, or release claims.
- [`stonysystems/jetpack` at `c03e318ec355b11edd42aac56c68d0765f88d1d2`](https://github.com/stonysystems/jetpack/tree/c03e318ec355b11edd42aac56c68d0765f88d1d2) and the [OSDI 2026 paper](https://www.usenix.org/system/files/osdi26-tang.pdf) — pinned MIT-licensed design, TLA+, fault-scenario, and benchmark references for optional crash-fault consensus acceleration; external proofs, code behavior, and performance claims do not transfer to Molten.
- [Schema Migration Core](https://seed.radicle.garden/z1C4YVMgDGyVdQa72uPNj3UDS5cY.git) at `4fe90e130f2871cf69a6febcdc70785adca98aea` — bounded migration planning pilot without runtime or storage authority.
- [WalTier](https://github.com/danthegoodman1/waltier) — MIT reference for an object-store CAS-arbitrated ordered log. Molten keeps its store, consistency, authority, and evidence semantics.
- [`adanil-code/LRUHashTable`](https://github.com/adanil-code/LRUHashTable) — Apache-2.0 design reference for lazy promotion and deferred release. Molten keeps explicit bounds, BLAKE3 keys, dataspace authority, and policy semantics.
...
- [`rivet-dev/actors`](https://github.com/rivet-dev/actors/tree/71f371ba4eab1234d8b6b6c419e6748cc6fc9911) at `71f371ba4eab1234d8b6b6c419e6748cc6fc9911` — Apache-2.0 design reference for keyed addressability, generation fencing, sleep and rewake separation, and explicit persisted classes. Molten keeps Preserves identity, fabric ownership, Basalt/UCAN authority, logical time, survival rules, effect uncertainty, and evidence semantics; Rivet APIs, formats, benchmarks, and service claims are not compatibility targets.
- [*The Synit Manual*](https://synit.org/book/) — CC BY 4.0 design reference for reactive dataspaces, assertion lifetimes, facets, capability attenuation, declared service state, and causal turn traces. Molten keeps its own Preserves envelopes, receipts, Basalt/UCAN authority, lifecycle states, and evidence boundaries; Synit wire protocol, relays, sturdyrefs, and configuration scripting are not compatibility targets. See [`docs/synit-incorporation-review.md`](docs/synit-incorporation-review.md).
