...
The strict gate is fail-closed: `warning-only` denies even when `cargo-octet` exits `0`, and `command.txt`, `status.json`, `summary.txt`, structured finding keys, object corpus receipts, and fingerprint evidence are bound by canonical refs in the Octet receipt. Current remediation snapshot: workspace and lib-only Octet are `clean` with 0 findings, 0 warnings, and 0 errors; focused object corpus has 2852 objects (`b3:6dc8a98479722f5dcc6d8a3a33f0784a1b0373dd2e6d992d5a9eeb7c3c1c767d`); latest artifact import receipt is `blake3:b0636777455d05a67337e177d2f67c909bff5e9f7561e06338300b4d950cd656`, latest strict pass receipt is `blake3:7d602935633923105b5c83e00e347e60a0298e4537e3afeadc64e93b2abac2c6`, and latest remediation plan receipt is `blake3:50dae888b49b2ac6bded45c72df881143bf07b846a68debc6ef7b7520d1d9be4`. Caveat: this is configuration-clean with the broad high-noise lint families explicitly disabled in `dylint.toml`; source-remediated zero for those disabled families remains separate follow-up work. Nix/dogfood was not rerun for the Dogfood-only disabled-lint burn-down slice. During warning burn-down only, use the explicit quarantine flow:
