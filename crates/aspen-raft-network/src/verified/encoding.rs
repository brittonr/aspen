...
///
/// ```
/// use aspen_raft_network::verified::encode_shard_prefix;
///
/// let shard_id = 42u32;
...
///
/// ```
/// use aspen_raft_network::verified::decode_shard_prefix;
///
/// let prefix = [0, 0, 0, 42];
...
///
/// ```
/// use aspen_raft_network::verified::try_decode_shard_prefix;
///
