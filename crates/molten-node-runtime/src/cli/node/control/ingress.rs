pub(crate) fn build(input: super::super::command::control::IngressBuild) -> molten_node_runtime::error::Result<()> {
    ...
    let envelope = molten_node_runtime::node_daemon::control_ingress_envelope(&molten_node_runtime::node_daemon::ControlIngressEnvelopeInput {
    ...
    super::super::core::write_file(&out, &molten_node_runtime::preserves_rail::to_text(&envelope.value)?)?;
    println!(
...
pub(crate) fn live_build(input: super::super::command::control::IngressLiveBuild) -> molten_node_runtime::error::Result<()> {
    ...
    let request_value = super::super::core::read_preserves_file(&request)?;
    let envelope =
        molten_node_runtime::node_daemon::control_live_ingress_envelope(&molten_node_runtime::node_daemon::ControlIngressEnvelopeInput {
            request_value: &request_value,
            from_peer: &from_peer,
            to_node: &to_node,
            topic: &topic,
...
pub(crate) fn live_loopback(input: super::super::command::control::IngressLiveLoopback) -> molten_node_runtime::error::Result<()> {
    ...
    let loopback = runtime.block_on(molten_node_runtime::node_daemon::control_live_iroh_loopback(
        &molten_node_runtime::node_daemon::ControlLiveLoopbackInput {
    ...
    if let Some(path) = publish_receipt_out.as_ref() {
        super::super::core::write_file(path, &molten_node_runtime::preserves_rail::to_text(&loopback.publish_receipt_value)?)?;
    }
...
pub(crate) fn live_send(input: super::super::command::control::IngressLiveSend) -> molten_node_runtime::error::Result<()> {
...
impl LiveSendValues {
    fn read(input: &super::super::command::control::IngressLiveSend) -> molten_node_runtime::error::Result<Self> {
...
fn send_live(
...
) -> molten_node_runtime::error::Result<molten_node_runtime::node_daemon::ControlLiveSend> {
    let ticket = molten_node_runtime::node_daemon::parse_control_live_ticket(&values.ticket_value)?;
    let default_profile_alpns = [molten_node_runtime::node_daemon::LIVE_CONTROL_INGRESS_TRANSPORT.to_string()];
    ...
    let topology_profile =
        input.topology_profile_ref.as_deref().map(|profile_ref| molten_node_runtime::node_daemon::LiveTopologyProfile {
            profile_ref,
    ...
    let transport_profile =
        input.transport_profile_ref.as_deref().map(|profile_ref| molten_node_runtime::node_daemon::LiveTransportProfile {
            profile_ref,
    ...
    let runtime = tokio::runtime::Builder::new_multi_thread()
        ...
        .build()
        .map_err(molten_node_runtime::error::Failure::from)?;
    runtime.block_on(molten_node_runtime::node_daemon::send_control_live_ingress(&molten_node_runtime::node_daemon::ControlLiveSendInput {
...
fn write_live_send_outputs(
    input: &super::super::command::control::IngressLiveSend,
    sent: &molten_node_runtime::node_daemon::ControlLiveSend,
    ...
    if let Some(dir) = input.retry_receipts_dir.as_ref() {
        std::fs::create_dir_all(dir).map_err(molten_node_runtime::error::Failure::from)?;
        for (reference, value) in sent.retry_receipt_refs.iter().zip(sent.retry_receipt_values.iter()) {
            ...
            super::super::core::write_file(&path, &molten_node_runtime::preserves_rail::to_text(value)?)?;
        }
    }
...
pub(crate) fn publish(input: super::super::command::control::IngressPublish) -> molten_node_runtime::error::Result<()> {
    ...
    let published = molten_node_runtime::node_daemon::publish_control_ingress(&molten_node_runtime::node_daemon::ControlIngressPublishInput {
        state_root: &state_root,
...
pub(crate) fn deliver(input: super::super::command::control::IngressDeliver) -> molten_node_runtime::error::Result<()> {
    ...
    let delivered = molten_node_runtime::node_daemon::deliver_control_ingress(&molten_node_runtime::node_daemon::ControlIngressDeliverInput {
        state_root: &state_root,
        topic: &topic,
