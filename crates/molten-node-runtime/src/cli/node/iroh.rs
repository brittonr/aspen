type Outcome<T> = molten_node_runtime::error::Result<T>;
...
pub(super) fn router_fixture(input: super::command::iroh::RouterFixture) -> Outcome<()> {
    ...
    let install =
        molten_node_runtime::node_iroh::evaluate_router_operation(&molten_node_runtime::node_iroh::empty_protocol_registry(), &install_input)?;
    ...
    let replace = molten_node_runtime::node_iroh::evaluate_router_operation(&install.registry, &replace_input)?;
    ...
    let remove = molten_node_runtime::node_iroh::evaluate_router_operation(&replace.registry, &remove_input)?;
    let unsupported_input = molten_node_runtime::node_iroh::RouterOperationInput {
    ...
    let unsupported = molten_node_runtime::node_iroh::evaluate_router_operation(&remove.registry, &unsupported_input)?;
    let value = molten_node_runtime::preserves_rail::record("node-iroh-router-fixture-v1", vec![
        molten_node_runtime::preserves_rail::record("insert", vec![install.receipt_value]),
        molten_node_runtime::preserves_rail::record("replace", vec![replace.receipt_value]),
        molten_node_runtime::preserves_rail::record("remove", vec![remove.receipt_value]),
        molten_node_runtime::preserves_rail::record("unsupported", vec![unsupported.receipt_value]),
    ]);
...
pub(super) fn frame_fixture(input: super::command::iroh::FrameFixture) -> Outcome<()> {
    let registry = molten_node_runtime::node_iroh::evaluate_router_operation(
        &molten_node_runtime::node_iroh::empty_protocol_registry(),
        &router_input("install", ROUTER_GENERATION_ONE),
    )?
    .registry;
    let envelope =
        molten_node_runtime::preserves_rail::record("node-control-envelope", vec![molten_node_runtime::preserves_rail::string("status")]);
    let bytes = molten_node_runtime::preserves_rail::canonical_bytes(&envelope)?;
    let frame = molten_node_runtime::node_iroh::evaluate_framed_envelope(&registry, &molten_node_runtime::node_iroh::FramedEnvelopeInput {
        ...
        declared_envelope_ref: molten_node_runtime::preserves_rail::content_ref_from_bytes(&bytes),
        envelope_bytes: bytes,
        limit_profile_ref: molten_node_runtime::node_iroh::default_limit_profile_ref(),
        authority_refs: refs("authority"),
        policy_refs: refs("policy"),
        resource_refs: refs("resource"),
        evidence_refs: refs("frame-evidence"),
        limits: molten_node_runtime::node_iroh::FramedEnvelopeLimits {
            max_frame_bytes: FRAME_MAX_BYTES,
            max_frames_per_session: FRAME_MAX_COUNT,
            max_outstanding_frames: FRAME_MAX_COUNT,
        },
    })?;
    let frame_ref = molten_node_runtime::preserves_rail::canonical_hash(&frame.receipt_value)?;
    let service = molten_node_runtime::node_iroh::evaluate_service_session(&molten_node_runtime::node_iroh::ServiceSessionInput {
    ...
    let value = molten_node_runtime::preserves_rail::record("node-iroh-frame-fixture-v1", vec![
        molten_node_runtime::preserves_rail::record("frame", vec![frame.receipt_value]),
        molten_node_runtime::preserves_rail::record("service-session", vec![service.receipt_value]),
    ]);
...
pub(super) fn diagnostics_fixture(input: super::command::iroh::DiagnosticsFixture) -> Outcome<()> {
    let report = molten_node_runtime::node_iroh::network_diagnostics_report(&molten_node_runtime::node_iroh::NetworkDiagnosticsInput {
    ...
    let probe = molten_node_runtime::node_iroh::connectivity_probe_receipt(&molten_node_runtime::node_iroh::ConnectivityProbeInput {
    ...
    let watcher = molten_node_runtime::node_iroh::watcher_snapshot_value(&molten_node_runtime::node_iroh::NetworkWatcherInput {
    ...
    let value = molten_node_runtime::preserves_rail::record("node-network-diagnostics-fixture-v1", vec![
        molten_node_runtime::preserves_rail::record("report", vec![report.receipt_value]),
        molten_node_runtime::preserves_rail::record("probe", vec![probe.receipt_value]),
        molten_node_runtime::preserves_rail::record("watcher", vec![watcher.receipt_value]),
    ]);
...
pub(super) fn metrics_fixture(input: super::command::iroh::MetricsFixture) -> Outcome<()> {
    let metrics = molten_node_runtime::node_iroh::metrics_snapshot(&molten_node_runtime::node_iroh::MetricsSnapshotInput {
        node: "node:a".to_string(),
        scrape_ref: fixture_ref("scrape"),
        policy_refs: refs("policy"),
        redaction_refs: refs("redaction"),
        samples: vec![molten_node_runtime::node_iroh::MetricSample {
...
pub(super) fn port_mapping_fixture(input: super::command::iroh::PortMappingFixture) -> Outcome<()> {
    let receipt = molten_node_runtime::node_iroh::port_mapping_receipt(&molten_node_runtime::node_iroh::PortMappingInput {
...
pub(super) fn external_bridge_fixture(input: super::command::iroh::ExternalBridgeFixture) -> Outcome<()> {
    let receipt =
        molten_node_runtime::node_iroh::external_diagnostics_bridge_receipt(&molten_node_runtime::node_iroh::ExternalDiagnosticsBridgeInput {
...
fn router_input(operation: &str, generation: u64) -> molten_node_runtime::node_iroh::RouterOperationInput {
    molten_node_runtime::node_iroh::RouterOperationInput {
...
fn fixture_ref(label: &str) -> String {
    molten_node_runtime::node_iroh::fixture_ref(label)
}
