pub(crate) fn reconcile(input: super::super::command::live::Reconcile) -> molten_node_runtime::error::Result<()> {
    ...
    let reconciled = molten_node_runtime::node_daemon::reconcile_control_live_workflow_bundle(
        &molten_node_runtime::node_daemon::ControlLiveWorkflowBundleReconcileInput {
...
pub(crate) fn export(input: super::super::command::live::AckExport) -> molten_node_runtime::error::Result<()> {
    ...
    let exported = molten_node_runtime::node_daemon::export_control_live_workflow_bundle_ack(
        &molten_node_runtime::node_daemon::ControlLiveWorkflowBundleAckExportInput {
            apply_receipt_value: &apply_receipt_value,
            send_receipt_value: send_receipt_value.as_ref(),
            ingress_receipt_value: ingress_receipt_value.as_ref(),
            queue_receipt_value: queue_receipt_value.as_ref(),
    ...
    super::super::core::write_file(&out, &molten_node_runtime::preserves_rail::to_text(&exported.ack.ack_value)?)?;
    super::super::core::emit_named_receipt(
        receipt_out.as_ref(),
...
pub(crate) fn import(input: super::super::command::live::AckImport) -> molten_node_runtime::error::Result<()> {
    ...
    let imported = molten_node_runtime::node_daemon::import_control_live_workflow_bundle_ack(
        &molten_node_runtime::node_daemon::ControlLiveWorkflowBundleAckImportInput {
...
pub(crate) fn protocol_gate(input: super::super::command::live::ProtocolGate) -> molten_node_runtime::error::Result<()> {
    ...
    let reconcile_receipt_value = super::super::core::read_preserves_file(&reconcile_receipt)?;
    let ack_value = super::super::core::read_preserves_file(&ack)?;
    let gated = molten_node_runtime::node_daemon::gate_control_live_workflow_protocol(
        &molten_node_runtime::node_daemon::ControlLiveWorkflowProtocolGateInput {
...
fn read_optional(path: Option<&std::path::PathBuf>) -> molten_node_runtime::error::Result<Option<preserves::IOValue>> {
    path.map(|path| super::super::core::read_preserves_file(path)).transpose()
}

fn print_export_next_step(exported: &molten_node_runtime::node_daemon::ControlLiveWorkflowBundleAckExport) {
...
fn print_import_next_step(imported: &molten_node_runtime::node_daemon::ControlLiveWorkflowBundleAckImport) {
...
fn print_protocol_gate_next_step(gated: &molten_node_runtime::node_daemon::ControlLiveWorkflowProtocolGate) {
...
fn print_reconcile_next_step(reconciled: &molten_node_runtime::node_daemon::ControlLiveWorkflowBundleReconcile) {
