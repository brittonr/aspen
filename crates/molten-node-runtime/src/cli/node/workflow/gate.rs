pub(crate) fn run(input: super::super::command::live::Gate) -> molten_node_runtime::error::Result<()> {
    ...
    let gated = molten_node_runtime::node_daemon::gate_control_live_workflow_bundle(
        &molten_node_runtime::node_daemon::ControlLiveWorkflowBundleGateInput {
...
fn print_next_step(gated: &molten_node_runtime::node_daemon::ControlLiveWorkflowBundleGate) {
