...
pub(crate) struct Init {
    ...
    #[arg(long, default_value = molten_node_runtime::preserves_rail::PROD_OPS_DEPLOYMENT_PROFILE_SCHEMA)]
...
pub(crate) struct RunLoop {
    #[arg(long)]
    pub(crate) state_root: std::path::PathBuf,
    #[arg(long, default_value_t = molten_node_runtime::node_daemon::DEFAULT_CONTROL_LOOP_REQUESTS)]
...
pub(crate) struct Serve {
    ...
    #[arg(long, default_value_t = molten_node_runtime::node_daemon::DEFAULT_CONTROL_SERVICE_TICKS)]
    ...
    #[arg(long, default_value_t = molten_node_runtime::node_daemon::DEFAULT_CONTROL_LIVE_LISTENER_EVENTS)]
    pub(crate) live_max_events: u64,
    #[arg(long, default_value_t = molten_node_runtime::node_daemon::DEFAULT_CONTROL_LIVE_LISTENER_TIMEOUT_MS)]
