...
mod tests {
    ...
    fn test_vm_state_parsing() {
        assert_eq!(VmApiState::from_str("Running"), Some(VmApiState::Running));
        assert_eq!(VmApiState::from_str("Paused"), Some(VmApiState::Paused));
        assert_eq!(VmApiState::from_str("Unknown"), None);
    }
}
