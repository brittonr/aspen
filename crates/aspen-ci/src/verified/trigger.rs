...
///
/// ```
/// use aspen_ci::verified::ref_matches_pattern;
///
/// // Exact match
...
///
/// ```
/// use aspen_ci::verified::ref_matches_any_pattern;
///
...
///
/// ```
/// use aspen_ci::verified::path_matches_pattern;
///
/// // Exact match
...
///
/// ```
/// use aspen_ci::verified::any_path_matches;
///
...
///
/// ```
/// use aspen_ci::verified::extract_branch_name;
///
...
///
/// ```
/// use aspen_ci::verified::extract_tag_name;
///
...
///
/// ```
/// use aspen_ci::verified::is_branch_ref;
///
...
///
/// ```
/// use aspen_ci::verified::is_tag_ref;
///
