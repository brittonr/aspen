...
pub(crate) fn default_dns_bind_addr() -> SocketAddr {
    SocketAddr::new(std::net::IpAddr::V4(std::net::Ipv4Addr::new(127, 0, 0, 1)), 5353)
}

pub(crate) fn default_dns_zones() -> Vec<String> {
    vec!["aspen.local".to_string()]
}

pub(crate) fn default_dns_upstreams() -> Vec<SocketAddr> {
    vec![
...
pub(crate) fn default_dns_forwarding() -> bool {
    true
}
