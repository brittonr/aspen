...
//! 3. **SVCNAME-3: Body Byte Admission**: valid names contain only lowercase ASCII, digits, dots,
//!    or hyphens.
//! 4. **SVCNAME-4: Rejection Completeness**: empty, overlong, or malformed byte strings are
//!    rejected.
