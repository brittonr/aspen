...
///
/// ```
/// use aspen_ci_core::verified::compute_effective_pid_limit;
///
/// // Requested within limits
...
///
/// ```
/// use aspen_ci_core::verified::compute_memory_high_watermark;
///
/// const GB: u64 = 1024 * 1024 * 1024;
///
/// // 75% of 4 GB (with integer division rounding)
/// let expected_75 = (4 * GB / 100) * 75;
/// assert_eq!(compute_memory_high_watermark(4 * GB, 75), expected_75);
///
/// // 100% equals max (special case to avoid rounding)
...
pub const fn compute_memory_high_watermark(max_bytes: u64, high_percentage: u32) -> u64 {
    // Handle 100% specially to avoid rounding errors
...
///
/// ```
/// use aspen_ci_core::verified::format_bytes_for_cgroup;
///
