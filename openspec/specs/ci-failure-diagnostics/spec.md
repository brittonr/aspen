...
Defines the CI Failure Diagnostics capability requirements preserved by Aspen's archived OpenSpec records, including bounded Nix stderr, timeout finalization, dogfood pipeline failure details, and reliable log/progress streaming.
