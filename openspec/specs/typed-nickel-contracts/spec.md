...
- GIVEN sponsored runtime contract families such as provider offers, sponsor policies, resource class catalogs, admission profiles, principal role bindings, resource grants, quota ledgers, and usage receipts
...
- AND it MUST mark raw secrets, payment credentials, payment rail internals, human-account internals, exchange rates, authorization proof verification, metering behavior, and Raft state transitions as non-candidates for Nickel ownership
