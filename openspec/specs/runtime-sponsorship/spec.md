# runtime-sponsorship Specification

## Purpose

This spec defines Aspen's sponsored runtime grant boundary: principal-based sponsorship actors, currency-neutral resource sponsorship, provider acceptance policy, quota accounting, and signed redacted usage receipts. Aspen owns resource authority, admission, quota ledgers, and evidence shapes while bilateral settlement, payment rails, pricing, and currency semantics remain external.
