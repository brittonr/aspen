# ucan-auth-integration Specification

## Purpose

This spec defines Aspen's sibling UCAN adoption boundary for capability-token issuance, verification, dependency ownership, and operator-facing compatibility. It preserves Aspen-specific capability and authorization semantics behind an adapter while delegating generic UCAN semantics to the sibling implementation.
