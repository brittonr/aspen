# aspen-hardening-audit Specification

## Purpose

This specification defines Aspen's reproducible full-system hardening audit contract. It covers the inventory, authorization matrix, credential-redaction evidence, execution/network/supply-chain evidence, and remediation closeout gates required before broad hardening audits can be accepted or archived.
