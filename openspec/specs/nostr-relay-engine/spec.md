...
- **THEN** the relay SHALL respond with a JSON document containing `name`, `description`, `pubkey` (the cluster's Nostr npub), `supported_nips` ([1, 11, 34]), and `software` fields
