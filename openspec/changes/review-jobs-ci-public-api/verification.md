...
- [x] Readiness checker passed with no failures or warnings.
  ...
  - Evidence: `openspec/changes/review-jobs-ci-public-api/evidence/jobs-ci-core-readiness.json`
...
scripts/check-crate-extraction-readiness.rs --policy docs/crate-extraction/policy.ncl --inventory docs/crate-extraction.md --manifest-dir docs/crate-extraction --candidate-family jobs-ci-core --output-json openspec/changes/review-jobs-ci-public-api/evidence/jobs-ci-core-readiness.json --output-markdown openspec/changes/review-jobs-ci-public-api/evidence/jobs-ci-core-readiness.md
...
markdownlint docs/**/*.md openspec/changes/review-jobs-ci-public-api/**/*.md openspec/specs/jobs-ci-core-extraction/spec.md
git diff --check
```
