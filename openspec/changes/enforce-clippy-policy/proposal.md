...
- **Files**: crate roots that participate in the enforced baseline, new top-level `clippy.toml`, and OpenSpec artifacts under `openspec/changes/enforce-clippy-policy/`.
