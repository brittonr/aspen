...
- Evidence: `openspec/changes/enforce-clippy-policy/evidence/rollout-inventory.md`
- Evidence: `openspec/changes/enforce-clippy-policy/evidence/rollout-candidate-crates.tsv`
- Evidence: `openspec/changes/enforce-clippy-policy/evidence/aspen-time-baseline.txt`
- Evidence: `openspec/changes/enforce-clippy-policy/evidence/canonical-clippy.txt`
- Evidence: `openspec/changes/enforce-clippy-policy/evidence/notes.txt`
...
- Evidence: `openspec/changes/enforce-clippy-policy/evidence/source-diff.txt`
- Evidence: `openspec/changes/enforce-clippy-policy/evidence/canonical-clippy.txt`
...
- Evidence: `openspec/changes/enforce-clippy-policy/evidence/canonical-rustdoc.txt`
- Evidence: `openspec/changes/enforce-clippy-policy/evidence/local-ci-parity.md`
...
- Evidence: `scripts/clippy-policy.sh`
- Evidence: `openspec/changes/enforce-clippy-policy/evidence/canonical-entrypoint.md`
- Evidence: `openspec/changes/enforce-clippy-policy/evidence/local-ci-parity.md`
...
- Evidence: `openspec/changes/enforce-clippy-policy/evidence/lint-suppression-policy.md`
- Evidence: `openspec/changes/enforce-clippy-policy/evidence/source-diff.txt`
...
- Evidence: `openspec/changes/enforce-clippy-policy/evidence/unsafe-inventory.md`
- Evidence: `openspec/changes/enforce-clippy-policy/evidence/unsafe-grep.txt`
...
- Evidence: `openspec/changes/enforce-clippy-policy/evidence/local-ci-parity.md`
- Evidence: `openspec/changes/enforce-clippy-policy/evidence/canonical-entrypoint.md`
- Evidence: `openspec/changes/enforce-clippy-policy/evidence/negative-proof.txt`
- Evidence: `openspec/changes/enforce-clippy-policy/evidence/unsafe-inventory.md`
- Evidence: `openspec/changes/enforce-clippy-policy/evidence/source-diff.txt`
- Evidence: `openspec/changes/enforce-clippy-policy/evidence/openspec-preflight.txt`

## Verification Commands

- Command: `./scripts/clippy-policy.sh clippy`
  - Artifact: `openspec/changes/enforce-clippy-policy/evidence/canonical-clippy.txt`
- Command: `./scripts/clippy-policy.sh rustdoc`
  - Artifact: `openspec/changes/enforce-clippy-policy/evidence/canonical-rustdoc.txt`
- Command: `TMPDIR=/run/user/$UID/tmp env -u CARGO_INCREMENTAL RUSTC_WRAPPER= cargo clippy --manifest-path openspec/changes/enforce-clippy-policy/evidence/negative-proof-module/Cargo.toml -- -D warnings`
  - Artifact: `openspec/changes/enforce-clippy-policy/evidence/negative-proof.txt`
- Command: `scripts/openspec-preflight.sh enforce-clippy-policy`
  - Artifact: `openspec/changes/enforce-clippy-policy/evidence/openspec-preflight.txt`

## Changed file evidence

- Changed file: `openspec/changes/enforce-clippy-policy/tasks.md`
- Changed file: `openspec/changes/enforce-clippy-policy/verification.md`
- Changed file: `openspec/changes/enforce-clippy-policy/evidence/source-diff.txt`
- Changed file: `openspec/changes/enforce-clippy-policy/evidence/openspec-preflight.txt`
