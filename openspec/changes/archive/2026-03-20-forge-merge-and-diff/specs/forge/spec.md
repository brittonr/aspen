...
The system SHALL store Git objects (commits, trees, blobs, tags) as content-addressed blobs via iroh-blobs. Objects SHALL be retrievable by their Git SHA and distributable across cluster nodes. The system SHALL support reading individual files from the tree at a specific commit without full checkout. The system SHALL support comparing trees and commits to produce structured diffs, and merging trees via three-way merge.
