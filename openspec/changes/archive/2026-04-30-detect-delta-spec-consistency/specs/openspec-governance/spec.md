...
### Requirement: Delta specs are structurally consistent [r[openspec-governance.delta-spec-consistency]]
...
#### Scenario: Added requirements have IDs [r[openspec-governance.delta-spec-consistency.added-requirements-have-ids]]
...
#### Scenario: Modified requirement exists [r[openspec-governance.delta-spec-consistency.modified-requirement-exists]]
...
#### Scenario: Missing modified target fails [r[openspec-governance.delta-spec-consistency.missing-modified-target-fails]]
...
#### Scenario: Removed requirement exists [r[openspec-governance.delta-spec-consistency.removed-requirement-exists]]
...
#### Scenario: Migration note permits intentional repair [r[openspec-governance.delta-spec-consistency.migration-note-permits-repair]]
...
#### Scenario: Conflicting feature contracts warn [r[openspec-governance.delta-spec-consistency.conflicting-feature-contracts-warn]]
