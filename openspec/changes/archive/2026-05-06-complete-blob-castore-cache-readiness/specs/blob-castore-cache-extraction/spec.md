...
ID: blob-castore-cache-extraction.promotion-requires-complete-evidence
...
ID: blob-castore-cache-extraction.promotion-requires-complete-evidence.evidence
...
ID: blob-castore-cache-extraction.adapter-paths-explicit

#### Scenario: Adapter paths remain explicit evidence [r[blob-castore-cache-extraction.adapter-paths-explicit.evidence]]
ID: blob-castore-cache-extraction.adapter-paths-explicit.evidence
