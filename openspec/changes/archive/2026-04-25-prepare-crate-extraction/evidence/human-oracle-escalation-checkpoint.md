...
2. Capture the exact failing review/gate transcript under `openspec/changes/archive/2026-04-25-prepare-crate-extraction/evidence/`.
...
- `verification.md` links `openspec/changes/archive/2026-04-25-prepare-crate-extraction/evidence/openspec-gate-tasks-i8.txt` for the original captured gate transcript.
- The V2 checkpoint gate rejected a premature checked V2 status; the corrected task state unchecks V2, keeps its evidence prepared-only, and records `openspec/changes/archive/2026-04-25-prepare-crate-extraction/evidence/openspec-gate-tasks-v2.txt` plus `openspec/changes/archive/2026-04-25-prepare-crate-extraction/evidence/openspec-gate-tasks-v2-corrected.txt`.
