...
### Requirement: OCI Artifact Lowering
...
#### Scenario: OCI image lowers to microVM by default
...
#### Scenario: OCI lowering receipt preserves original and derived identities
...
#### Scenario: Plain container runner is dev or unsafe only
...
#### Scenario: OCI image artifact selected
...
#### Scenario: OCI image verified before isolated lowering
