{
  description = "MVM-CI Worker MicroVMs without networking (for development)";
  ...
  outputs = { self, nixpkgs, microvm }:
    ...
    in
    {
      # Service VM configuration without networking
      ...
      # Worker VM configuration without networking
