# Normal node content service

## Why

The preceding pilot proved real Molten transport between VMs through an example driver. Operators need the same protected content path through the normal node lifecycle. The example must not become an undocumented production daemon.
