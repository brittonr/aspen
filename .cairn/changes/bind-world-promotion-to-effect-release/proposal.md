...
- `adopt-artifact-binding-and-semantic-effects` and the reviewed Weft effect-log core.
- Transactional Reconciliation Core.
- Existing Molten effect handles, replay policy, delivery idempotency, and durable-state transactions.
