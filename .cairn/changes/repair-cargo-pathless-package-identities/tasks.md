...
- [x] [serial] Verify actual locked all-feature metadata and nextest through the repaired toolchain. Cite r[molten.toolchain.pathless_acceptance]. Evidence: repository `evidence/native-fixture-hashing/validation.md`.
