...
- [x] [depends:bind-world-promotion-to-effect-release] Bind promotion-gated decisions to release reservation admission without authorizing dispatch from the policy receipt. r[molten.world_branch_authority.activation]
