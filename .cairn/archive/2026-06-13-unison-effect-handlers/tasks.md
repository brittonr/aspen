...
- [x] [serial] r[molten.effects.dataspace_handlers] Add local and production handler bindings for dataspace send and observe effects.
- [x] [serial] r[molten.effects.blob_handlers] Add local and Iroh-backed handler bindings for blob get and blob put effects.
- [x] [parallel] r[molten.effects.storage_handlers] Add local and Redb-backed handler bindings for typed storage read/write effects.
- [x] [parallel] r[molten.effects.time_random_handlers] Add deny-by-default clock and random handlers with deterministic local test implementations.
...
- [x] [serial] r[molten.effects.chaos_profile] Add a bounded chaos handler profile for deterministic fault, delay, reorder, and partition injection.
- [x] [parallel] r[molten.effects.profiling_profile] Add a profiling handler profile that records effect counts, payload sizes, dependency fetches, and trace references.
- [x] [serial] r[molten.effects.transcript_tests] Add executable transcript tests that pin handler profiles and expected canonical traces/receipts.
- [x] [parallel] r[molten.effects.property_tests] Add Hegel property tests for deny-by-default behavior, handler substitution, and effect-request determinism.
