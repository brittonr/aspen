...
- [x] [parallel] r[molten.runtime.adapter_remote_proxy_preflight.replay] Add gate checks for adapter/proxy preflight binding, transcript replay, permission binding, and non-replayable exclusion.
- [x] [parallel] r[molten.runtime.adapter_remote_proxy_preflight.authority] Add negative tests for missing/tampered manifests, undeclared permissions, unknown peers, transcript mismatch, stale signatures, and ambient side-channel attempts.
