...
//!
//! This module provides a trait-based abstraction over the P2P transport layer,
...
///
/// ```ignore
/// use aspen::cluster::transport::NetworkTransport;
///
...
///
/// ```ignore
/// use aspen::cluster::transport::{PeerDiscovery, DiscoveredPeer};
///
