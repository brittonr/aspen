...
pub struct KeyInput {
    ...
    pub policy_export_refs: Vec<String>,
...
pub struct GetInput {
    ...
    pub current_policy_export_refs: Vec<String>,
    pub current_capability_refs: Vec<String>,
    pub current_revocation_refs: Vec<String>,
    pub current_resource_refs: Vec<String>,
    pub current_handler_profile_ref: Option<String>,
    pub current_provenance_refs: Vec<String>,
    pub current_source_gate_refs: Vec<String>,
    pub current_retention_refs: Vec<String>,
    pub current_evidence_refs: Vec<String>,
    pub compatibility_refs: Vec<String>,
    pub semantic: bool,
}
...
pub struct CacheHitValidityInput<'a> {
    ...
    pub current_policy_export_refs: &'a [String],
    pub current_capability_refs: &'a [String],
    pub current_revocation_refs: &'a [String],
    pub current_resource_refs: &'a [String],
    pub current_handler_profile_ref: Option<&'a str>,
    pub current_provenance_refs: &'a [String],
    pub current_source_gate_refs: &'a [String],
    pub current_retention_refs: &'a [String],
    pub current_evidence_refs: &'a [String],
    pub compatibility_refs: &'a [String],
