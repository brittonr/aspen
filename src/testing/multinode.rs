include!("multinode/parts/p000/body.rs");
...
include!("multinode/parts/p007/body.rs");

#[cfg(test)]
mod tests {
    include!("multinode/parts/tests/p000/body.rs");
    include!("multinode/parts/tests/p001/body.rs");
    include!("multinode/parts/tests/p002/body.rs");
}
