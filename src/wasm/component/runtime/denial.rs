pub(crate) fn plan_denied_outcome(
    request: &super::shell::ComponentExecutionRequest<'_>,
    plan: &super::super::admission::ComponentExecutionPlan,
    denial: super::super::model::ComponentDenial,
    mut receipts: Vec<super::super::evidence::receipt::ComponentReceipt>,
    input_ref: Option<String>,
) -> super::super::model::ComponentResult<super::shell::ComponentExecutionOutcome> {
    ...
    let denial_receipt = super::super::evidence::receipt::build_component_receipt(
        super::super::evidence::receipt::ComponentReceiptInput {
            stage: super::super::evidence::receipt::ComponentReceiptStage::Denial,
            decision: super::super::evidence::receipt::ComponentReceiptDecision::Deny,
    ...
    Ok(super::shell::ComponentExecutionOutcome {
        decision: super::super::evidence::receipt::ComponentReceiptDecision::Deny,
        output: None,
        receipts,
...
pub(crate) fn denied_outcome(
    request: &super::shell::ComponentExecutionRequest<'_>,
    denial: super::super::model::ComponentDenial,
) -> super::shell::ComponentExecutionOutcome {
    let component =
        super::super::evidence::materialization::MaterializedObjectIdentity::measure(request.source.component_bytes());
    let wit = super::super::evidence::materialization::MaterializedObjectIdentity::measure(request.source.wit_bytes());
    let component_ref =
        component.map_or_else(|_| super::super::model::content_ref(&[]), |identity| identity.content_ref);
    let wit_ref = wit.map_or_else(|_| super::super::model::content_ref(&[]), |identity| identity.content_ref);
    let context = denial_context(request.source);
    let denial_class = denial.canonical_class().to_string();
    let profile_ref = super::super::profile::component_profile_ref(request.profile);
    let runtime_configuration_ref =
        super::super::model::content_ref(format!("denied:{profile_ref}:{component_ref}:{wit_ref}").as_bytes());
    let receipt = super::super::evidence::receipt::build_component_receipt(
        super::super::evidence::receipt::ComponentReceiptInput {
            stage: super::super::evidence::receipt::ComponentReceiptStage::Denial,
            decision: super::super::evidence::receipt::ComponentReceiptDecision::Deny,
            evidence_scope: request.evidence_scope,
            ...
            imports: super::super::model::sorted_unique(&request.facts.imports),
...
struct DenialContext {
    ...
    consumer: super::super::model::ComponentConsumer,
...
fn denial_context(source: super::super::evidence::materialization::ComponentArtifactSource<'_>) -> DenialContext {
    match source {
        super::super::evidence::materialization::ComponentArtifactSource::Mantle { bundle, envelope, .. } => {
            ...
            DenialContext {
                bundle_ref: Some(super::super::evidence::materialization::mantle_bundle_ref(bundle)),
        ...
        super::super::evidence::materialization::ComponentArtifactSource::TestOnlyLoose { .. } => DenialContext {
            bundle_ref: None,
...
fn valid_refs(values: &[String]) -> Vec<String> {
    super::super::model::sorted_unique(
        &values
            .iter()
            .filter(|value| super::super::model::valid_content_ref(value))
            .cloned()
            .collect::<Vec<_>>(),
    )
}
