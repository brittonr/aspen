...
fn mantle_materialized_component_executes_through_generated_wit_bindings() {
    ...
    for consumer in [ComponentConsumer::Actor, ComponentConsumer::SystemExtension] {
        let fixture = super::support::ComponentFixture::new(consumer);
...
fn component_shell_denies_malformed_wrong_world_and_over_resource_requests_with_receipts() {
    ...
    let mut malformed = super::support::ComponentFixture::new(ComponentConsumer::Actor);
    ...
    let mut wrong_world = super::support::ComponentFixture::new(ComponentConsumer::Actor);
    ...
    let mut exhausted = super::support::ComponentFixture::new(ComponentConsumer::Actor);
...
fn production_loose_bytes_and_core_module_requests_never_fall_back() {
    ...
    let mut core = super::support::ComponentFixture::new(ComponentConsumer::Actor);
...
fn component_shell_denies_invalid_preserves_output_and_fuel_exhaustion() {
    ...
    let mut invalid_output = super::support::ComponentFixture::new(ComponentConsumer::Actor);
    invalid_output.replace_component_bytes(super::support::invalid_output_component_bytes());
    ...
    let mut fuel_exhaustion = super::support::ComponentFixture::new(ComponentConsumer::Actor);
    fuel_exhaustion.replace_component_bytes(super::support::fuel_exhaustion_component_bytes());
...
fn component_shell_reinspects_resource_facts_and_rejects_actual_growth() {
    ...
    let mut forged = super::support::ComponentFixture::new(ComponentConsumer::Actor);
    ...
    let mut growing = super::support::ComponentFixture::new(ComponentConsumer::Actor);
    growing.replace_component_bytes(super::support::dynamic_growth_component_bytes());
    ...
    let (over_limit_bytes, declared_bytes) = super::support::over_limit_memory_component_bytes();
    let mut over_limit = super::support::ComponentFixture::new(ComponentConsumer::Actor);
