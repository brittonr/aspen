...
fn materialization_rejects_tampered_stale_incomplete_and_circular_bundles() {
    ...
    let mut tampered = super::support::ComponentFixture::new(ComponentConsumer::Actor);
    tampered.bundle.component.content_ref = super::support::fixture_ref("other-component");
    ...
    let mut tampered_wit = super::support::ComponentFixture::new(ComponentConsumer::Actor);
    ...
    let mut stale = super::support::ComponentFixture::new(ComponentConsumer::Actor);
    ...
    let mut incomplete = super::support::ComponentFixture::new(ComponentConsumer::Actor);
    ...
    let mut over_bound = super::support::ComponentFixture::new(ComponentConsumer::Actor);
    over_bound.bundle.stage_receipt_refs =
        vec![super::support::fixture_ref("over-bound-stage"); OVER_BOUND_EVIDENCE_REF_COUNT];
    ...
    let mut circular = super::support::ComponentFixture::new(ComponentConsumer::Actor);
    circular.bundle.embedded_admission_refs = vec![super::support::fixture_ref("circular-admission")];
