...
mod tests {
    ...
    include!(concat!(env!("CARGO_MANIFEST_DIR"), "/src/remote/parts/dataspace/tests/m000/p004/body.rs"));
    ...
    include!(concat!(env!("CARGO_MANIFEST_DIR"), "/src/remote/parts/dataspace/tests/m000/p003/body.rs"));
}
