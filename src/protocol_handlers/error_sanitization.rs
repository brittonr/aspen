...
pub fn sanitize_control_error(err: &crate::api::ControlPlaneError) -> String {
...
pub fn sanitize_kv_error(err: &crate::api::KeyValueStoreError) -> String {
...
pub fn sanitize_blob_error(err: &crate::blob::BlobStoreError) -> String {
