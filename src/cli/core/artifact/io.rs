pub(super) fn cli_artifact_ref(kind: &str, label: &str) -> molten::error::Result<String> {
    molten::preserves_rail::canonical_hash(&molten::preserves_rail::record("artifact-cli-ref", vec![
