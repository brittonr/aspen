...
mod tests {
    ...
    include!(concat!(env!("CARGO_MANIFEST_DIR"), "/src/evidence/parts/chain/tests/m000/p005/body.rs"));
    ...
    include!(concat!(env!("CARGO_MANIFEST_DIR"), "/src/evidence/parts/chain/tests/m000/p006/body.rs"));
}
