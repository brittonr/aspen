...
pub const REMOTE_DATASPACE_SESSION_SCHEMA: &str = "molten.remote-dataspace.session.v1";
pub const REMOTE_DATASPACE_APPLIED_ASSERTION_SCHEMA: &str = "molten.remote-dataspace.applied-assertion.v1";
...
pub const PROD_RELEASE_CANDIDATE_GATE_SCHEMA: &str = "molten.prod-release.candidate-gate.v2";
...
pub const PLUGIN_EXTENSION_CONTRACT_SCHEMA: &str = "molten.plugin.extension-contract.v1";
pub const PLUGIN_EXTENSION_NEGOTIATION_RECEIPT_SCHEMA: &str = "molten.plugin.extension-negotiation-receipt.v1";
pub const PLUGIN_EXTENSION_COMPATIBILITY_RECEIPT_SCHEMA: &str = "molten.plugin.extension-compatibility-receipt.v1";
