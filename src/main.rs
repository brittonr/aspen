...
enum TestCommand {
    ...
    ReplayFixture {
        #[command(subcommand)]
        command: cli_replay_fixture::ReplayFixtureCommand,
    },
    Report {
        #[command(subcommand)]
    ...
    Receipt {
        #[command(subcommand)]
        command: cli_receipts::ReceiptCommand,
    },
    Ledger {
        #[command(subcommand)]
...
fn run_test_command(command: TestCommand) -> Result<()> {
    match command {
        ...
        TestCommand::Receipt { command } => cli_receipts::run_receipt_command(command),
