    ...
    fn cli_secrets_commands_work() {
        ...
        let summary = molten::secrets::fixture_report_summary(&report_value).expect("summary");
        ...
        let parsed = molten::secrets::parse_secret_ref(&secret_value).expect("parse secret");
    ...
    fn cli_plugin_lifecycle_commands_work() {
        ...
        let parsed = molten::plugin_host::parse_plugin_manifest(&manifest_value).expect("parse plugin manifest");
