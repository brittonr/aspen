...
mod tests {
    ...
    include!(concat!(env!("CARGO_MANIFEST_DIR"), "/src/deterministic/parts/replay/tests/m000/p006/body.rs"));
    ...
    include!(concat!(env!("CARGO_MANIFEST_DIR"), "/src/deterministic/parts/replay/tests/m000/p005/body.rs"));
}
