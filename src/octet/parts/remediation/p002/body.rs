...
const SURFACES: &[SurfaceDefinition] = &[
    ...
    SurfaceDefinition {
        ...
        files: &[
            "crates/molten-node-runtime/src/node/runtime.rs",
            "crates/molten-node-runtime/src/node/identity.rs",
    ...
    SurfaceDefinition {
        ...
        files: &[
            ...
            "crates/molten-node-runtime/src/cli/node/authority.rs",
            "crates/molten-node-runtime/src/cli/node/command.rs",
            "crates/molten-node-runtime/src/cli/node/command/authority.rs",
            "crates/molten-node-runtime/src/cli/node/command/base.rs",
            "crates/molten-node-runtime/src/cli/node/command/control.rs",
            "crates/molten-node-runtime/src/cli/node/command/health.rs",
            "crates/molten-node-runtime/src/cli/node/command/live.rs",
            "crates/molten-node-runtime/src/cli/node/control.rs",
            "crates/molten-node-runtime/src/cli/node/control/ingress.rs",
            "crates/molten-node-runtime/src/cli/node/core.rs",
            "crates/molten-node-runtime/src/cli/node/health.rs",
            "crates/molten-node-runtime/src/cli/node/lifecycle.rs",
            "crates/molten-node-runtime/src/cli/node/workflow.rs",
            "crates/molten-node-runtime/src/cli/node/workflow/ack.rs",
            "crates/molten-node-runtime/src/cli/node/workflow/apply.rs",
            "crates/molten-node-runtime/src/cli/node/workflow/bundle.rs",
            "crates/molten-node-runtime/src/cli/node/workflow/gate.rs",
