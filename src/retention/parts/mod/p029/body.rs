...
mod tests {
    ...
    include!(concat!(env!("CARGO_MANIFEST_DIR"), "/src/retention/parts/mod/tests/m000/p009/body.rs"));
    include!(concat!(env!("CARGO_MANIFEST_DIR"), "/src/retention/parts/mod/tests/m000/p001/body.rs"));
    include!(concat!(env!("CARGO_MANIFEST_DIR"), "/src/retention/parts/mod/tests/m000/p010/body.rs"));
    include!(concat!(env!("CARGO_MANIFEST_DIR"), "/src/retention/parts/mod/tests/m000/p011/body.rs"));
    ...
    include!(concat!(env!("CARGO_MANIFEST_DIR"), "/src/retention/parts/mod/tests/m000/p012/body.rs"));
