...
Defines replay-bound delivery idempotency, scoped operation identity, dedup windows, retry guidance, and evidence-only delivery diagnostics for Molten runtime boundaries.
