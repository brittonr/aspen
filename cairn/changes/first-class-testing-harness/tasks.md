...
- [x] [serial] r[molten.testing.golden_traces] Maintain versioned golden canonical trace, receipt, and state-hash artifacts with reviewed update receipts and migration notes.
