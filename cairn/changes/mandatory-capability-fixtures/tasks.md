...
- [x] [serial] r[molten.testing.mandatory_capabilities.no_implicit_execution] Reject evidence-bearing execution when the capability fixture is omitted.
...
- [x] [serial] r[molten.testing.mandatory_capabilities.negative_tests] Add negative coverage for omitted fixtures and keep explicit empty fixtures as valid deny-by-default authority contexts.
