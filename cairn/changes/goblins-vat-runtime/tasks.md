...
- [x] [parallel] r[molten.runtime_spine.time_travel_debugging] Define trace, snapshot, and replay hooks for time-travel and distributed object debugging.
- [x] [parallel] r[molten.runtime_spine.authority_graph_inspection] Define an authority-aware inspection surface for object reference graphs and snapshots.
- [x] [parallel] r[molten.runtime_spine.portable_encrypted_storage] Define content-addressed, encrypted, chunked, provider-independent storage requirements for snapshots, blobs, documents, and large payloads.
...
- [x] [parallel] r[molten.runtime_spine.promise_property_tests] Add Hegel property tests for bounded promise pipelines, resolution/failure ordering, and queue cleanup.
- [x] [parallel] r[molten.runtime_spine.actormap_property_tests] Add Hegel property tests for generated actormap turn deltas preserving rollback/commit invariants.
