...
- [x] [serial] r[molten.testing.basalt_ucan_capability_preflight.authority_receipt] Recompute capability preflight evidence from embedded suites and reject stale or tampered gates.
...
- [x] [parallel] r[molten.testing.basalt_ucan_capability_preflight.proofset_binding] Add negative coverage for missing/tampered authority receipts, non-empty UCAN proofsets, and tampered grant refs.
- [x] [parallel] r[molten.testing.basalt_ucan_capability_preflight.gate_receipts] Update docs and examples of evidence rails.
