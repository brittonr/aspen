...
- Move Transcript command enums and dispatch from `src/main.rs` into a focused `src/cli_transcript.rs` module as the next transcript/replay CLI shell hotspot split.
