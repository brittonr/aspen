...
- Preserve existing `molten test octet ...`, `molten test retention ...`, `molten test delivery ...`, `molten test provenance ...`, `molten test protocol ...`, `molten test job ...`, `molten test secrets ...`, `molten test plugin ...`, and `molten node ...` command syntax, receipt output, denial behavior, and canonical Preserves values.
