...
- [ ] [serial] r[molten.octet_source_remediated_zero.disabled_lint_burndown] Continue splitting module-count, file-length, function-length, import, and path-repetition hotspots until disabled lint families can be removed or narrowed with source-remediated-zero evidence.
