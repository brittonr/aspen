...
- [x] [serial] Record focused authentication and source-check baselines plus the pre-existing Cairn policy-schema blocker. r[molten.artifact_auth_adoption.radicle_behavior]
- [x] [serial] Pin all consumed Artifact packages to one immutable revision and regenerate Cargo and Nix locks with owning tools. r[molten.artifact_auth_adoption.source] r[molten.artifact_auth_adoption.radicle_agreement]
- [x] [serial] Consolidate the release profile and both unit2nix plans on the one Artifact source. r[molten.artifact_auth_adoption.radicle_agreement]
