...
- [x] [serial] r[molten.testing.nixos_vm_multinode.receipts] Emit canonical VM topology, per-node evidence, and VM test run receipts that bind Nix inputs/store refs, child receipts, replay status, diagnostics, logs, and evidence-only caveats.
