...
- [x] [serial] r[molten.testing.mandatory_budget.explicit_fixture.omitted] Reject evidence-bearing execution when the budget fixture is omitted.
...
- [x] [serial] r[molten.testing.mandatory_budget.explicit_fixture.tight] Add negative coverage for omitted budgets and legacy default-budget reports while keeping explicit tight budgets as resource divergence evidence.
