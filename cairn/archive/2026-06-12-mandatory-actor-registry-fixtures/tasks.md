...
- [x] [serial] r[molten.testing.mandatory_actor_registry.explicit_fixture] Reject evidence-bearing execution when the actor registry fixture is omitted.
...
- [x] [serial] r[molten.testing.mandatory_actor_registry.explicit_fixture.empty] Add negative coverage for omitted registries, explicit empty registries, unknown actors, and unsupported executor kinds.
