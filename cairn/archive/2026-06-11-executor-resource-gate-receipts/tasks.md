...
- [x] [serial] r[molten.evidence.executor_resource_gate_receipts.aggregate_ref] Add the aggregate execution receipt ref to gate receipt artifact refs.
...
- [x] [parallel] r[molten.evidence.executor_resource_gate_receipts.validation] Add tests proving gate receipts expose the new executor resource checks and reject missing checks.
